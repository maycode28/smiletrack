...
export default function AddCase() {
    ...
    return (
        <div className="min-h-screen font-sans text-slate-900">
            <Header/>
            <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 pb-32">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                            <div>
                                ...
                                <div className="relative group">
                                    ...
                                    />
                                    <span
                                        className="material-symbols-outlined text-sm absolute right-3 top-1/2 -translate-y-1/2">keyboard_arrow_down</span>
                                </div>
                            </div>
                            <div>
                                <label className="block text-sm font-medium mb-2 text-slate-700">Specific
                                    Product</label>
                                <div className="relative group">
